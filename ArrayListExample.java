...
public class ArrayListExample {
    public static void main(String args[]) {
        ...
        System.out.println("\nCurrently the array list obj1 after removing elements: " + obj1);

        obj1.remove(1);

        System.out.println("\nCurrently the array list obj1 after removing element through index: " + obj1);
        ...
        if (obj3.size() > 0) {
            System.out.println("\nArrayList obj1 contains strings starting with "
                    + search + ": " + obj3);
        } else {
